...
class Widget extends \WP_Widget {
	...
	public function __construct() {
		$widget_ops  = array(
			'classname'   => 'mailgun-subscriptions',
			'description' => __( 'A mailgun list subscription form', 'mailgun-subscriptions' ),
		);
		$control_ops = array();
	...
	public function form( $instance ) {
		...
		?>
		<p><label
				for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'mailgun-subscriptions' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>"
						 name="<?php echo $this->get_field_name( 'title' ); ?>" type="text"
						 value="<?php echo esc_attr( $title ); ?>"/></p>

		<p><label
				for="<?php echo $this->get_field_id( 'content' ); ?>"><?php _e( 'Description:', 'mailgun-subscriptions' ); ?></label>
		...
		<p>
			<input class="widefat" id="<?php echo $this->get_field_id( 'name' ); ?>"
						 ...
						 type="checkbox" <?php checked( isset( $instance[ 'name' ] ) && $instance[ 'name' ] === 'on' ); ?> />
			<label
				for="<?php echo $this->get_field_id( 'name' ); ?>"><?php _e( 'Require name?', 'mailgun-subscriptions' ); ?></label>
		</p>

		<p><label
				for="<?php echo $this->get_field_id( 'lists' ); ?>"><?php _e( 'List Options:', 'mailgun-subscriptions' ); ?></label>
		<ul>
			<?php foreach ( Plugin::instance()->get_lists( 'name' ) as $list_address => $list_settings ): ?>
				<li>
					<label><input type="checkbox" value="<?php esc_attr_e( $list_address ); ?>"
												name="<?php echo $this->get_field_name( 'lists' ); ?>[]"
